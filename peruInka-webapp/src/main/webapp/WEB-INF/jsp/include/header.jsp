			...
			<div class="nav-collapse">
				<nav class="nav">
					<ul class="nav">
						...
						<li <c:if test="${menuHeader eq 'hotel'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/hotel/hotel.html">Hotel</a></li>
						<li <c:if test="${menuHeader eq 'product'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/product/product.html">Producto</a></li>
						<li <c:if test="${menuHeader eq 'customer'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/customer/customer.html">Cliente</a></li>
						<li <c:if test="${menuHeader eq 'ticket'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/ticket/ticket.html">Ticket</a></li>
						<li <c:if test="${menuHeader eq 'ticketDescription'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/ticket/ticketDescrition.html"></a>Descripcion de Ticket</li>
						<li <c:if test="${menuHeader eq 'enterprice'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/enterprice/enterprice.html"></a>Empresa</li>
